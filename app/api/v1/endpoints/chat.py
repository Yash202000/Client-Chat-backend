...
@router.get("/channels/{channel_id}/members", response_model=List[UserSchema])
...
@router.post("/channels/{channel_id}/members", response_model=chat_schema.ChannelMembership)
